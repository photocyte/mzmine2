...
class Ms2NeutralLossSearchTask extends AbstractTask {
    ...
    public Ms2NeutralLossSearchTask(ParameterSet parameters, PeakList peakList1,
        ...
        mzTolerance = parameters.getParameter(Ms2NeutralLossSearchParameters.mzTolerance)
                .getValue();
        
        scoreThreshold = parameters.getParameter(Ms2NeutralLossSearchParameters.scoreThreshold)
                .getValue();
        
        intensityThreshold = parameters.getParameter(Ms2NeutralLossSearchParameters.intensityThreshold)
                .getValue();
        
        minimumIonsMatched = parameters.getParameter(Ms2NeutralLossSearchParameters.minimumIonsMatched)
                .getValue();
        
        massListName = parameters.getParameter(Ms2NeutralLossSearchParameters.massList)
                .getValue();
    ...
    private void addFragmentClusterIdentity(PeakListRow row1, Feature peakA,
        ...
        Ms2NeutralLossIdentity newIdentity = new Ms2NeutralLossIdentity(peakA, peakB, searchResult);
