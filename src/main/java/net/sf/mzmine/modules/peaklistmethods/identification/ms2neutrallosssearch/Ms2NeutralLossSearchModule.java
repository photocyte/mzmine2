...
public class Ms2NeutralLossSearchModule implements MZmineProcessingModule {
    ...
    public ExitCode runModule(@Nonnull MZmineProject project,
        ...
        PeakList peakLists1[] = parameters
                .getParameter(Ms2NeutralLossSearchParameters.peakLists1).getValue()
                .getMatchingPeakLists();
        
        PeakList peakLists2[] = parameters
                .getParameter(Ms2NeutralLossSearchParameters.peakLists2).getValue()
                .getMatchingPeakLists();
        ...
        //Now a single task.
        Task newTask = new Ms2NeutralLossSearchTask(parameters, peakList1, peakList2);
        tasks.add(newTask);
    ...
    public @Nonnull Class<? extends ParameterSet> getParameterSetClass() {
        return Ms2NeutralLossSearchParameters.class;
    }
