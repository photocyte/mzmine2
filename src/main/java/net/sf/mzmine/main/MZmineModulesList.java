...
import net.sf.mzmine.modules.peaklistmethods.identification.ms2neutrallosssearch.Ms2NeutralLossSearchModule;
...
public class MZmineModulesList {
    ...
    public static final Class<?> MODULES[] = new Class<?>[] {
            ...
            Ms2SearchModule.class, Ms2NeutralLossSearchModule.class,
